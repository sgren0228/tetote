    ...
    <main>
        <section id="fv">
            <div class="fv__wrapper">
                ...
                <div class="fv__inner">
                    ...
                    <p class="fv__catchphrase">君の挑戦が、意思が、未来を変える</p>
                    <div class="fv-news">
                        <span class="fv-news__title">NEWS</span>
                        <p class="fv-news__text">新入社員向けに、入社前研修を行いました。</p>
                    </div>
                </div>
            </div>
        </section>
            ...
            <div class="about__wrapper">
                <div class="about-slider">
                    ...
                    <div class="about-slider__box">
                        ...
                        <p class="about-slider__text">それこそが、我々の使命だ</p>
                    </div>
                </div>
        ...
        <section id="member">
            <div class="member__wrapper">
                <h2 class="sec-title">
                    <span class="sec-title__en">MEMBER</span>
                    <span class="sec-title__ja"><span class="border">人</span>を知る</span>
                </h2>
                <p class="sec__description">TETOTEの社員がどういった信念を持って働いているのか、<br>一日のスケジュールや仕事内容などを紹介します。</p>
                    ...
                    <ul class="slideshow-track">
                        <li class="slide-list">
                            ...
                            <div class="member__info">
                                <span class="member__status">コンサルタント</span>
                                <span class="member__date">2011年入社</span>
                            </div>
                            <span class="member__name">西村 優</span>
                        </li>
                        ...
                        <li class="slide-list">
                            ...
                            <div class="member__info">
                                <span class="member__status">コンサルタント</span>
                                <span class="member__date">2015年入社</span>
                            </div>
                            <span class="member__name">橋本 拓也</span>
                        </li>
                        ...
                        <li class="slide-list">
                            ...
                            <div class="member__info">
                                <span class="member__status">ソリューション営業</span>
                                <span class="member__date">2017年入社</span>
                            </div>
                            <span class="member__name">青木 美月</span>
                        </li>
                        ...
                        <li class="slide-list">
                            ...
                            <div class="member__info">
                                <span class="member__status">データサイエンティスト</span>
                                <span class="member__date">2002年入社</span>
                            </div>
                            <span class="member__name">高橋 智</span>
                        </li>
                        ...
                        <li class="slide-list">
                            ...
                            <div class="member__info">
                                <span class="member__status">コンサルタント</span>
                                <span class="member__date">2006年入社</span>
                            </div>
                            <span class="member__name">高田 凛</span>
                        </li>
                        ...
                        <li class="slide-list">
                            ...
                            <div class="member__info">
                                <span class="member__status">システム事業部課長</span>
                                <span class="member__date">2007年入社</span>
                            </div>
                            <span class="member__name">橘 光</span>
                        </li>
                    </ul>
                </div>
        ...
        <section id="benefits">
            <div class="benefits__wrapper">
                <h2 class="sec-title">
                    <span class="sec-title__en">BENEFITS</span>
                    <span class="sec-title__ja"><span class="border">制度・環境</span>を知る</span>
                </h2>
                <p class="sec__description">当社では働く従業員とそのご家族が健やかに過ごせるよう、多様な研修、福利厚生を提供しています。</p>
                <div class="benefits__items">
                    <div class="benefits__item">
                        ...
                        <div class="benefits__text">個々の目標に合わせたキャリアパスを支える、豊富な研修メニューで、あなた自身の成長を強力にサポートします。</div>
                    </div>
                    <div class="benefits__item">
                        <div class="benefits-icon">
                        ...
                        <div class="benefits__text">TETOTEの福利厚生制度は、従業員の健康と幸福を重視し、働きやすい環境を提供することを目的としています。</div>
                    </div>
                </div>
            </div>
        </section>
        ...
        <section id="blog">
            <div class="blog__wrapper">
                <h2 class="sec-title">
                    <span class="sec-title__en">BLOG</span>
                    <span class="sec-title__ja">採用ブログ</span>
                </h2>
                <p class="sec__description">
                    採用情報やイベント情報、社員の紹介など、<br>日々の現場の様子をご紹介します。
                </p>
                <a href=""><div class="sec-arrow sec-arrow--blog"></div></a>
                <div class="blog__items">
                    <article class="blog-item">
                        ...
                        <div class="blog-item__inner">
                            ...
                            <h3 class="blog-item__title">新入社員向けに、入社前研修を行いました。</h3>
                            <span class="blog-item__date">2025.03.25</span>
                        </div>
                    </article>
                    <article class="blog-item">
                        <figure class="blog-item__img">
        ...
        <section id="recruitment">
            <div class="recruitment__wrapper">
                <h2 class="sec-title">
                    <span class="sec-title__en">RECRUITMENT</span>
                    <span class="sec-title__ja">採用情報</span>
                </h2>
                <p class="sec__description">
